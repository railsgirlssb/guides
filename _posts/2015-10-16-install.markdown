...
Folge den Instruktionen für dein Betriebssystem. Falls dabei Probleme auftreten sollten, keine Sorge, gib uns bitte via <a href="mailto:railsgirlssb@gmail.com">E-Mail</a> Bescheid und wir lösen die Probleme gemeinsam.
Eventuell können dir auch Freune/Freundinnen mit deinem Problem helfen.
...
Einzelne Schritte der Anleitung können länger dauern, da Software zunächst aus dem Internet runtergeladen werden muss und es eventuell keinen Fortschrittsbalken oder ähnlich gibt.
Manchmal kommt auf viel kryptische Ausgabe. Das soll zunächst auch niemanden beunruhigen.

Falls die Anleitung auf dein Betriebssystem nicht zutrifft, melde dich bitte bei uns, damit wir da gemeinsam durchsteigen.
...
Gib anschließend die Tastenkombination <code>STRG + C</code> ein und bestätige die daraufflogende Frage mit <code><J/code>.

Du kannst nun das Terminalfenster schließen.
